...
def start_gui():
    ...
    system_trash = CTkCheckBox(system_labels_frame, text='/share/Trash/', variable = trash, onvalue='on', offvalue='off', fg_color=dark_green, hover_color=green)
    system_trash.pack(pady=5)
